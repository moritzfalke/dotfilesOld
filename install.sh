...
# install things
#
# some code taken from https://github.com/Parth/dotfiles
...
#customizations for zsh, loaded by oh-my-zsh
#ln -nsf $DOTFILES_ROOT/zsh/prompt.zsh ~/.oh-my-zsh/custom/prompt.zsh
...
# Installing all other tmux plugins
